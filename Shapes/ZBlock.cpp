...
ZBlock::ZBlock(int colPair) : Shape(colPair) {
...
ZBlock::ZBlock(int colPair, int orginY, int orginX) : Shape(colPair, orginY, orginX) {
    this->size = 4; //Apparently all tetris shapes are size 4
...
ZBlock::ZBlock(int colPair, int orginY, int orginX, int startingOrientation)
...
int ZBlock::getHeight() { //See header
...
int ZBlock::getWidth() { //See header
    if (POS0 == this->orientation || POS2 == this->orientation) {
        return 3;
    }
    else {
